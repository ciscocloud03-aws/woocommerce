...
<div class="wp-block-columns alignwide are-vertically-aligned-center has-background" style="background-color:#254094;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px">
	...
	<div class="wp-block-column is-vertically-aligned-center">
		...
		<div class="wp-block-group" style="padding-top:15px">
			<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500","fontSize":"45px","lineHeight":"0"},"color":{"text":"#C5D1E8"}}} -->
			<p class="has-text-color" style="color:#C5D1E8;font-size:45px;font-style:normal;font-weight:500;line-height:0">UP TO</p>
			<!-- /wp:paragraph -->
			...
			<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"300","fontSize":"35px","lineHeight":"0"},"color":{"text":"#C5D1E8"},"spacing":{"margin":{"bottom":"40px"}}}} -->
			<p class="has-text-color" style="color:#C5D1E8;margin-bottom:40px;font-size:35px;font-style:normal;font-weight:300;line-height:0"><?php echo esc_html( $description ); ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:buttons -->
			<div class="wp-block-buttons">
				<!-- wp:button {"style":{"color":{"background":"#ff7179","text":"#C5D1E8"},"border":{"radius":"40px","width":"0px","style":"none"},"spacing":{"padding":{"top":"10px","bottom":"10px","left":"30px","right":"30px"}}}} -->
				<div class="wp-block-button"><a class="wp-block-button__link has-text-color has-background wp-element-button" href="<?php echo esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ); ?>" style="border-style:none;border-width:0px;border-radius:40px;color:#C5D1E8;background-color:#ff7179;padding-top:10px;padding-right:30px;padding-bottom:10px;padding-left:30px">Shop now</a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
