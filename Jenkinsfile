             ...
             steps {
                 ...
                 script {
                     withCredentials([usernamePassword(credentialsId: 'github_pw', passwordVariable:"password", usernameVariable: "username")]) {
                         ...
                         sh "cat /var/jenkins_home/workspace/woocommerce/woo-manifest/woo-deploy.yaml"
                         sh "git add /var/jenkins_home/workspace/woocommerce/woo-manifest/woo-deploy.yaml"
                         sh "git status" // 상태 확인
